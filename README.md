...
**User guides:** [English](docs/USER_GUIDE.en.md) · [中文](docs/USER_GUIDE.zh.md)
...
Experience follows official challenge loops where implemented, but is **not** a full CR engine (curated player lists, instant resolution, omitted mechanics). Details: [user guide](docs/USER_GUIDE.en.md#3-challenge-experience).
...
High-res card PNG/`*-display.jpg` under `public/assets/cards/` are gitignored; CI regenerates on deploy.
