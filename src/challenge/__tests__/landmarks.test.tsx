...
describe('Challenge play landmarks', () => {
  it('renders fit shell chrome landmarks', () => {
    ...
    expect(html).toContain('arena-board-stage')
    expect(html).toContain('arena-board-pan')
    expect(html).toContain('arena-chrome-layer')
    ...
    expect(html).toContain('bf-half-opponent')
    expect(html).toContain('bf-half-player')
    expect(html).toContain('bf-half-divider')
    expect(html).toContain('player-phase-mark')
    expect(html).toContain('player-life-stack')
    expect(html).not.toContain('arena-midline')
    expect(html).not.toContain('phase-strip')
    expect(html).toContain('player-dock')
    expect(html).toContain('hand-dock-shell')
    expect(html).toContain('hand-dock-hotzone')
    expect(html).toContain('hand-dock')
    expect(html).toContain('hand-pin-btn')
    expect(html).toContain('mana-pool-hud')
    expect(html).toContain('arena-play-actions')
    expect(html).toContain('arena-primary-action')
    expect(html).toContain('arena-secondary-action')
    expect(html).toContain('arena-action-hint')
    expect(html).toContain('land-stack')
    expect(html).toContain('is-dense')
    expect(html).toContain('is-crowded')
    expect(html).toContain('is-playable')
    expect(html).toContain('settlement-panel')
  })
})
